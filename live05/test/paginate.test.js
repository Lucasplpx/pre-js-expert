  ...
  describe('#Pagination', () => {
    ...
    describe('#handleRequest', () => {
      it('should retry an request twice before throing an exception and validate request params and flow', async () => {
        ...
        const lastCall = 1;
        const firstCallArq = pagination.handleRequest.getCall(lastCall)
          .firstArg;
        const firstCallRetries = firstCallArq.retries;
    ...
    describe('#getPaginated', () => {
      const responseMock = [
        ...
        { tid: 5706, date: 1373124523, type: 'buy', price: 200, amount: 0.3 },
      ];
      ...
      it('should stop requesting when request return an empty array', async () => {
        ...
        const interator = await pagination.getPaginated(data);
