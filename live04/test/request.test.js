...
describe('Request helpers', () => {
  ...
  it(`shold return ok when promise time is ok`, async () => {
  ...
  it(`shold return a JSON object after a request`, async () => {
    const data = [Buffer.from('{"ok":'), Buffer.from('"ok"'), Buffer.from('}')];
